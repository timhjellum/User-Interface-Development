...
/***/ (function(module, exports) {
	...
	var Accordion = {
		...
		openAccordion: function openAccordion(toggle, content) {
			if (content.children.length) {
				toggle.classList.add("is-open");
				var final_height = Math.floor(content.children[0].offsetHeight);
				content.style.height = final_height + "px";
			}
		},

		closeAccordion: function closeAccordion(toggle, content) {
		...
		init: function init(el) {
			...
			var is_first_expanded = _this.settings.first_expanded;
			if (el.classList.contains("is-first-expanded")) is_first_expanded = true;
			var is_toggle = _this.settings.toggle;
			if (el.classList.contains("is-toggle")) is_toggle = true;

			// Loop through the accordion's sections and set up the click behavior
			var sections = el.getElementsByClassName("accordion");
			var all_toggles = el.getElementsByClassName("accordion-head");
			var all_contents = el.getElementsByClassName("accordion-body");

			var _loop = function _loop(i) {
				var section = sections[i];
				var toggle = all_toggles[i];

...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _scrollTo = __webpack_require__(29);

	var _scrollTo2 = _interopRequireDefault(_scrollTo);

	var _localScroll = __webpack_require__(30);
	...
	var _firefoxHack = __webpack_require__(33);
	    ...
	    _createClass(jqueryUI, [{
	        ...
	        value: function events() {
	            ...
	            (0, _jquery2.default)('.expand-collapse-container .expand').click(function () {
	                (0, _jquery2.default)(this).closest('div').find('h3').removeClass('ui-accordion-header-collapsed').addClass('ui-accordion-header-active').attr({ 'aria-selected': 'true', 'tabindex': '0' });
	                (0, _jquery2.default)(this).closest('div').find('.ui-accordion-content').addClass('ui-accordion-content-active').attr({ 'aria-expanded': 'true', 'aria-hidden': 'false' }).show();
	                ...
	                //});
	                (0, _jquery2.default)('.ui-accordion-header-icon').each(function (index, element) {
	                    (0, _jquery2.default)(element).removeClass('expand').addClass('collapse');
	                });
	            });
	            (0, _jquery2.default)('.expand-collapse-container .collapse').click(function () {
	                (0, _jquery2.default)(this).closest('div').find('h3').removeClass('ui-accordion-header-active').addClass('ui-accordion-header-collapsed').attr({ 'aria-selected': 'false', 'tabindex': '-1' });
	                (0, _jquery2.default)(this).closest('div').find('.ui-accordion-content').removeClass('ui-accordion-content-active').attr({ 'aria-expanded': 'false', 'aria-hidden': 'true' }).hide();
	                (0, _jquery2.default)(this).hide();
	                (0, _jquery2.default)(this).parent('span').find('.expand').show();
	                (0, _jquery2.default)('.ui-accordion-header-icon').each(function (index, element) {
	                    (0, _jquery2.default)(element).addClass('expand').removeClass('collapse');
	                });
	            });
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _localScroll = __webpack_require__(31);

	var _localScroll2 = _interopRequireDefault(_localScroll);

	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

	function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } } //const $ = require("jquery");

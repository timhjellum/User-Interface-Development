...
/***/ (function(module, exports, __webpack_require__) {
	...
	var Accordion = function () {
		function Accordion() {
			...
			this.headerInitialState = (0, _jquery2.default)('.accordion h2').first();
			this.headerExpandCollapseInitialState = (0, _jquery2.default)('.accordion h2 .expand-collapse').first();
			this.headerExpandCollapse = (0, _jquery2.default)('.accordion h2 .expand-collapse');
			this.contentInitialState = (0, _jquery2.default)('.accordion-content').first();
		...
		_createClass(Accordion, [{
			...
			key: 'events',
			value: function events() {
				(0, _jquery2.default)(this.header).click(function () {
					console.log('clicked');
					...
					(0, _jquery2.default)(this).children().removeClass('expand');
					(0, _jquery2.default)(this).next('.accordion-content').addClass('expanded');
				});

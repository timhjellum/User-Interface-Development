...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _jqueryUi = __webpack_require__(11);

	var _jqueryUi2 = _interopRequireDefault(_jqueryUi);

	var _analysisProjections = __webpack_require__(27);
	...
	var _firefoxHack = __webpack_require__(30);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _jqueryBxsliderMin = __webpack_require__(10);
	            ...
	            function bxSliderResize() {
	                ...
	                */
	                setTimeout(function () {
	                    ...
	                    console.log('reloadSlider - auto: ' + settings.auto + ', wrapper class: ' + settings.wrapperClass + ', start slide: ' + settings.startSlide + ', min slides: ' + settings.minSlides + ', max slides: ' + settings.maxSlides + ', move slides: ' + settings.moveSlides + ', next text: ' + settings.nextText + ', prev text: ' + settings.prevText + ', infinite loop: ' + settings.infiniteLoop + ', controls: ' + settings.controls + ', pager: ' + settings.pager + ', pager selector: ' + settings.pagerSelector + ', slide width: ' + settings.slideWidth + ', slide margin: ' + settings.slideMargin);
	                }, 2000);
	            }
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _formResetMixin = __webpack_require__(15);
	...
	var _effect = __webpack_require__(22);
	...
	var jqueryUI = function () {
	    function jqueryUI() {
	        ...
	        (0, _jquery2.default)('.accordion').accordion({
	            ...
	            activate: function activate(event, ui) {
	                if (!_jquery2.default.isEmptyObject(ui.newHeader.offset())) {
	                    (0, _jquery2.default)('html:not(:animated), body:not(:animated)').animate({ scrollTop: ui.newHeader.offset().top - 50 }, 'slow');
	                }
	            }
	        });

	        (0, _jquery2.default)('.accordion.all-open').accordion({
	            heightStyle: 'content',
	            active: true,
	            collapsible: true,
	            header: 'h3',
	        ...
	        (0, _jquery2.default)('.accordion.all-open h3').removeClass('ui-accordion-header-collapsed').addClass('ui-accordion-header-active').attr({ 'aria-selected': 'true', 'tabindex': '0' });
	        (0, _jquery2.default)('.accordion.all-open .ui-accordion-content').addClass('ui-accordion-content-active').attr({ 'aria-expanded': 'true', 'aria-hidden': 'false' }).show();

	        (0, _jquery2.default)('.accordion.first-open').accordion({
	            heightStyle: 'content',
	            collapsible: true
	        });
	        // set the initial state
	        (0, _jquery2.default)('.collapse').hide();

	        if ((0, _jquery2.default)('.accordion')[0]) {
	        ...
	        if (windowHash) {
	            ...
	            var target = (0, _jquery2.default)(windowHash);
	            target = target.length ? target : (0, _jquery2.default)('[name=' + windowHash.substr(1) + ']');
	            if (target.length) {
	                (0, _jquery2.default)('html, body').animate({
	                    scrollTop: target.offset().top - 60 }, 1000, function () {
	                    var $target = (0, _jquery2.default)(target);
	    ...
	    _createClass(jqueryUI, [{
	        key: 'events',
	        value: function events() {
	            (0, _jquery2.default)('.expand-collapse-container .expand').click(function () {
	                (0, _jquery2.default)(this).parent().next('div').find('h3').removeClass('ui-accordion-header-collapsed').addClass('ui-accordion-header-active').attr({ 'aria-selected': 'true', 'tabindex': '0' });
	                (0, _jquery2.default)(this).parent().next('div').find('.ui-accordion-content').addClass('ui-accordion-content-active').attr({ 'aria-expanded': 'true', 'aria-hidden': 'false' }).show();
	                (0, _jquery2.default)(this).hide();
	                (0, _jquery2.default)(this).parent('span').find('.collapse').show();
	                (0, _jquery2.default)(this).parent().next('div').find('.ui-accordion-header-icon').removeClass('expand').addClass('collapse').attr({ 'aria-selected': 'true', 'tabindex': '0' });
	            ...
	            (0, _jquery2.default)('.expand-collapse-container .collapse').click(function () {
	                (0, _jquery2.default)(this).parent().next('div').find('h3').removeClass('ui-accordion-header-active').addClass('ui-accordion-header-collapsed').attr({ 'aria-selected': 'false', 'tabindex': '-1' });
	                (0, _jquery2.default)(this).parent().next('div').find('.ui-accordion-content').removeClass('ui-accordion-content-active').attr({ 'aria-expanded': 'false', 'aria-hidden': 'true' }).hide();
	                (0, _jquery2.default)(this).hide();
	                (0, _jquery2.default)(this).parent('span').find('.expand').show();
	                (0, _jquery2.default)(this).parent().next('div').find('.ui-accordion-header-icon').removeClass('collapse').addClass('expand').attr({ 'aria-selected': 'true', 'tabindex': '0' });
...
/***/ (function(module, exports, __webpack_require__) {
	...
	( function( factory ) {
		if ( true ) {
			...
			!(__WEBPACK_AMD_DEFINE_ARRAY__ = [ __webpack_require__(2), __webpack_require__(13) ], __WEBPACK_AMD_DEFINE_FACTORY__ = (factory), __WEBPACK_AMD_DEFINE_RESULT__ = (typeof __WEBPACK_AMD_DEFINE_FACTORY__ === 'function' ? (__WEBPACK_AMD_DEFINE_FACTORY__.apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__)) : __WEBPACK_AMD_DEFINE_FACTORY__), __WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__));
		} else {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	( function( factory ) {
		if ( true ) {
			...
			// AMD. Register as an anonymous module.
			!(__WEBPACK_AMD_DEFINE_ARRAY__ = [ __webpack_require__(2), __webpack_require__(13), __webpack_require__(19) ], __WEBPACK_AMD_DEFINE_FACTORY__ = (factory), __WEBPACK_AMD_DEFINE_RESULT__ = (typeof __WEBPACK_AMD_DEFINE_FACTORY__ === 'function' ? (__WEBPACK_AMD_DEFINE_FACTORY__.apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__)) : __WEBPACK_AMD_DEFINE_FACTORY__), __WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__));
		} else {

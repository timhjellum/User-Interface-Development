	...
	var jqueryUI = function () {
	    ...
	    _createClass(jqueryUI, [{
	        ...
	        value: function events() {
	            ...
	            (0, _jquery2.default)('.expand-collapse-container span').click(function () {
	                (0, _jquery2.default)('#accordion .ui-accordion-header:not(.ui-state-active)').next().slideToggle();
	                (0, _jquery2.default)(this).text((0, _jquery2.default)(this).text() == 'Expand all' ? 'Collapse all' : 'Expand all');
	                (0, _jquery2.default)(this).toggleClass('collapse-all');
	                return false;
	            });
	            /*

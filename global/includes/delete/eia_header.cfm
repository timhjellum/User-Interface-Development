<div class="page-wrapper">
	<?php include('css_rehab/archive/global/includes/eia-social-sticker.inc') ?>
	<header>
		<div class="print">
		...
		<nav class="navigation">
			...
			<div class="nav-menu" style="display: none">
				<div class="section-tabs" id="menu">
					...
					<div id="nav-tools">
						<div class="tools left">
							<div class="nav-menu eia-glossary">
								...
								<?php include('css_rehab/archive/global/includes/eia-header-glossary.inc') ?>
							</div>
						...
						<div class="tools right">
							<div class="nav-menu reports">
								...
								<?php include('css_rehab/archive/global/includes/eia-header-reports-publications-search.inc') ?>
							</div>
							<div class="nav-menu survey-forms">
								...
								<?php /* include('css_rehab/archive/global/includes/eia-header-survey-search.inc') */ ?>
							</div>
					...
					<div id="nav-news">
						<div class="news left">
							<?php include('css_rehab/archive/global/includes/eia-header-whats-new.inc') ?>
						...
						<div class="news right">
							<div class="nav-menu upcoming">
								...
								<ul>
									<?php include('global/includes/homepage_comingup.html') ?>
								</ul>
							</div>

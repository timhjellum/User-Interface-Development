...
<html>
  <head>
    ...
    <link href="https://a248.e.akamai.net/assets.github.com/c4ac1e02d15a2c9cc382e8010c1cbb906696f3c3/stylesheets/bundle_github.css" media="screen" rel="stylesheet" type="text/css" />
    ...
    <script src="https://a248.e.akamai.net/assets.github.com/3e7df3d671903e8f683c361138d64c6c7259fcf5/javascripts/bundle_github.js" type="text/javascript"></script>
  ...
  <body class="logged_out page-blob  windows env-production">
    ...
    <ul class="actions">
        ...
        <li>
          <a href="/carhartl/jquery-cookie/toggle_watch" class="minibutton btn-watch " id="watch_button" onclick="var f = document.createElement('form'); f.style.display = 'none'; this.parentNode.appendChild(f); f.method = 'POST'; f.action = this.href;var s = document.createElement('input'); s.setAttribute('type', 'hidden'); s.setAttribute('name', 'authenticity_token'); s.setAttribute('value', '6f8d8e2fd4e741f8d16ef7c69a7ced132e8a183a'); f.appendChild(s);f.submit();return false;" style="display:none"><span><span class="icon"></span>Watch</span></a>
          <a href="/carhartl/jquery-cookie/toggle_watch" class="minibutton btn-watch " id="unwatch_button" onclick="var f = document.createElement('form'); f.style.display = 'none'; this.parentNode.appendChild(f); f.method = 'POST'; f.action = this.href;var s = document.createElement('input'); s.setAttribute('type', 'hidden'); s.setAttribute('name', 'authenticity_token'); s.setAttribute('value', '6f8d8e2fd4e741f8d16ef7c69a7ced132e8a183a'); f.appendChild(s);f.submit();return false;" style="display:none"><span><span class="icon"></span>Unwatch</span></a>
            ...
            <li class="for-notforked" style="display:none"><a href="/carhartl/jquery-cookie/fork" class="minibutton btn-fork " id="fork_button" onclick="var f = document.createElement('form'); f.style.display = 'none'; this.parentNode.appendChild(f); f.method = 'POST'; f.action = this.href;var s = document.createElement('input'); s.setAttribute('type', 'hidden'); s.setAttribute('name', 'authenticity_token'); s.setAttribute('value', '6f8d8e2fd4e741f8d16ef7c69a7ced132e8a183a'); f.appendChild(s);f.submit();return false;"><span><span class="icon"></span>Fork</span></a></li>
      ...
      <li class="repostats">
        <ul class="repo-stats">
          <li class="watchers"><a href="/carhartl/jquery-cookie/watchers" title="Watchers" class="tooltipped downwards">304</a></li>
          <li class="forks"><a href="/carhartl/jquery-cookie/network" title="Forks" class="tooltipped downwards">19</a></li>
        </ul>
      </li>
    </ul>
  ...
  <ul class="tabs">
    ...
    <li><a href="/carhartl/jquery-cookie/pulls" highlight="repo_pulls">Pull Requests (0)</a></li>
      ...
      <li><a href="/carhartl/jquery-cookie/issues" highlight="issues">Issues (3)</a></li>
  ...
  <ul>
    ...
    <div id="repo_details" class="metabox clearfix">
      ...
      <div id="repository_description_edit" style="display:none;" class="inline-edit">
        <form action="/carhartl/jquery-cookie/admin/update" method="post"><div style="margin:0;padding:0"><input name="authenticity_token" type="hidden" value="6f8d8e2fd4e741f8d16ef7c69a7ced132e8a183a" /></div>
  ...
  <img src="https://a248.e.akamai.net/assets.github.com/images/modules/ajax/big_spinner_336699.gif" height="32" width="32">
    ...
    <div id="footer" class="clearfix">
      <div class="site">
        ...
        <ul class="sosueme">
          <li class="main">&copy; 2011 <span id="_rrt" title="0.13098s from fe1.rs.github.com">GitHub</span> Inc. All rights reserved.</li>
    ...
    <script>window._auth_token = "6f8d8e2fd4e741f8d16ef7c69a7ced132e8a183a"</script>
...
`&lt;addr&gt;` element here instead.</pre>
    ...
    <script type="text/javascript">(function(){var d=document;var e=d.createElement("script");e.async=true;e.src="https://d1ros97qkrwjf5.cloudfront.net/10/eum/rum.js	";e.type="text/javascript";var s=d.getElementsByTagName("script")[0];s.parentNode.insertBefore(e,s);})();NREUMQ.push(["nrf2","beacon-1.newrelic.com","2f94e4d8c2",64799,"dw1bEBZcX1RWRhoEClsAGhcMXEQ=",0.0,131,new Date().getTime()])</script>
  </body>
</html>

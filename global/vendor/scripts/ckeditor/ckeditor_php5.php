...
class CKEditor
{
	 ...
	 * <strong>Note:</strong> this function will have no effect on already created editor instances.
	 *
	 ...
	 * <strong>Note:</strong> this function will have no effect if the event handler has been already printed/returned.
	 *
	 * @param $event (string) Event name, if not set all event handlers will be removed (optional).
	 */
	...
	private function ckeditorPath()
	{
		 ...
		 * <strong>Note:</strong> If a script is executed with the CLI, as a relative path, such as file.php or ../file.php,

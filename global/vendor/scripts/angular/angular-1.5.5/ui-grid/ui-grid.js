          ...
          post: function postlink($scope, $elm, $attrs, controllers) {
            ...
            gridUtil.on.mousewheel($elm, function (event) {
              ...
              if (event.deltaY !== 0) {
                ...
                scrollEvent.y = { percentage: scrollYPercentage, pixels: scrollYAmount, prevPercentage : (scrollTop / rowContainer.getVerticalScrollLength())};
              }
              if (event.deltaX !== 0) {
                ...
                scrollEvent.x = { percentage: scrollXPercentage, pixels: scrollXAmount, prevPercentage : (scrollLeft / (colContainer.getCanvasWidth() - colContainer.getViewportWidth())) };
              }
      ...
      return {
        ...
        link: function($scope, $elm, $attrs, controllers) {
          ...
          function scrollHandler(evt) {
            ...
            $scope.$emit(uiGridConstants.events.GRID_SCROLL);
          }
  ...
  angular.module('ui.grid')
    .factory('ScrollEvent', ['gridUtil', function (gridUtil) {
      ...
      ScrollEvent.prototype.atTop = function(scrollTop) {
        return (this.y && this.y.percentage === 0 && this.y.prevPercentage === 0);
      };

      ScrollEvent.prototype.atBottom = function(scrollTop) {
        return (this.y && this.y.percentage === 1 && this.y.prevPercentage === 1);
      };

      ScrollEvent.prototype.atLeft = function(scrollLeft) {
        return (this.x && this.x.percentage === 0 && this.x.prevPercentage === 0);
      };

      ScrollEvent.prototype.atRight = function(scrollLeft) {
        return (this.x && this.x.percentage === 1 && this.x.prevPercentage === 1);
      };

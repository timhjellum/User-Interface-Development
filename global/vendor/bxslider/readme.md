...
**pagerCustom**
Parent element to be used as the pager. Parent element must contain a <code>&lt;a data-slide-index="x"&gt;</code> element for each slide. See example <a href="/examples/thumbnail-method-1">here</a>. Not for use with dynamic sliders.
```
default: null
options: jQuery selector
```
...
**slideWidth**
The width of each slide. This setting is required for all horizontal sliders!
```
default: 0
options: integer
```
...
**shrinkItems**
The slider will only show whole items and shrink the images to fit the viewport based on maxSlides/MinSlides.
```
default: false
options: boolean (true / false)
```
...
### Version 4.2.5
* Fix: Vertical slider minSlides not working #840
...
* Enhancement: Added shrinkItems slider setting #772
...
### Version 4.1
* slider mode (minSlides / maxSlides) was re-written to be more intuitive.

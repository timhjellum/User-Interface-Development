...
<a name="pricesbyregion"></a>
                <h2>Gasoline prices by region</h2>
<p><a href="images/gasoline_prices_map_375.png" class="lightbox"><img src="images/gasoline_prices_map_375.png" /></a></p>
<a name="reformulatedmap"></a>                <h2>Reformulated Gasoline</h2>
<p><a href="images/formulation_map-lg.gif" class="lightbox"><img src="images/formulation_map-sm.gif" /></a></p>
                <h2><a name="statesmap"></a>States and cities in each PADD Region</h2>
<p><a href="images/paddmap-gas.png" class="lightbox"><img src="images/paddmap-gas.png" /></a></p>
                <h2><a name="city-county"></a>Retail Motor Gasoline City Definitions</h2>
<p>The table below shows the counties included in the sampling area for the ten cities that EIA publishes retail motor gasoline prices for. EIA does not have gasoline prices by county.
</p>
<table class="table">
<thead>
<tr>

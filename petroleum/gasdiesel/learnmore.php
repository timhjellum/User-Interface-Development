...
<p style="margin-left:10px"><strong>How can I register to receive weekly gasoline and diesel fuel oil data? </strong><br />
...
Every Monday, retail prices for all three grades of gasoline are collected by telephone from a sample of approximately 800 retail gasoline outlets. The prices are published around 5:00 p.m. ET Monday,... <a href="/petroleum/gasdiesel/gas_proc-methods.php">read more</a></p>
<p style="margin-left:10px"><strong>What are the diesel fuel oil price data collection methods? </strong><br />
Every Monday, cash self-serve on-highway diesel prices (including taxes) are collected from a sample of approximately 400 retail diesel outlets in the continental U.S. The sample includes a combination of truck stops and service stations that sell on-highway,... <a href="/petroleum/gasdiesel/diesel_proc-methods.php#procedures">read more</a><br />
<br />
<strong>What are motor gasoline sampling and estimation procedures?</strong><br />
The sample for the Motor Gasoline Price Survey was drawn from a frame of   approximately 115,000 retail gasoline outlets. The gasoline outlet frame was   constructed by combining information purchased from a private commercial source   with information contained on existing EIA petroleum product frames... <a href="/petroleum/gasdiesel/gas_proc-methods.php#sampling">read more</a></p>
<p style="margin-left:10px"><strong>What are diesel fuel oil sampling and estimation procedures?</strong><br />
The respondents reporting to the weekly diesel price survey represent a stratified probability proportional to size (PPS) sample selected from a frame list of retail outlets. The outlet sampling frame was constructed... <a href="/petroleum/gasdiesel/diesel_proc-methods.php#sampling">read more</a></p>
<p style="margin-left:10px"><strong>How reliable are the motor gasoline and diesel fuel oil prices? </strong><br />
...
<br />
&nbsp;&nbsp;&nbsp; See <a href="/petroleum/gasdiesel/gas_proc-methods.php#cv">on-highway motor gasoline prices and associated coefficients of variation</a><br />
&nbsp;&nbsp;&nbsp; See <a href="/petroleum/gasdiesel/diesel_proc-methods.php#cv">on-highway diesel fuel prices and associated coefficients of variation</a>
</p>

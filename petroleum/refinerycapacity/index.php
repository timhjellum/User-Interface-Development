...
<body>
    ...
    <?php $headtitle = 'Refinery Capacity Report'; ?>
    <?php $data_series = 'With Data as of January 1, 2017'; ?>
    <?php $release = 'June 21, 2017'; ?>
    ...
    <div class="l-row">
        <div class="l-split-wide-col">
            ...
            <p>
                ...
                Respondents are operators of all operating and idle petroleum refineries (including new refineries under construction) and refineries shut down during the previous year, located in the 50 States, the District of Columbia, Puerto Rico,
                the Virgin Islands, Guam, and other U.S. possessions. <br /><br /> The Refinery Capacity Report does not contain working and shell storage capacity data. This data is now being collected twice a year as of March 31 and
                September 30 on the Form EIA-810, "Monthly Refinery Report", and is now released as a separate report <a href="/petroleum/storagecapacity/">Working and Net Available Shell Storage Capacity</a>.
            </p>
            <table align="left">
                <span class="zebra-container">
            <span class="header"><a href="refcap17.xls"><i class="ico xls"><span>XLS</span></i>
                </a> --- Refinery Capacity Data by individual refinery as of <strong>January 1, 2017</h2>

<div><!-- accordion-panel --></span>
        
        <span class="zebra-container">
<td><strong>Source</strong> --- Energy Information Administration (EIA), Form EIA-820, "Annual Refinery Report".</td>
        </div>
    </div>
    <div class="zebra-wrapper" id="accordion" class="accordion">
        <span class="zebra-container">

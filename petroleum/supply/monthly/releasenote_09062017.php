...
<strong>Updated: September 6, 2017</strong></p>
<dl class="survey">
<p>
The U.S. Energy Information Administration (EIA) released the following new and revised data as well as data updated with hydrocarbon gas liquids (HGL) product categories on August 31, 2017.
</p>
<p>
...
<p>
We noticed some errors in the posted data for the historical petroleum supply series beginning with data for 2007.  We are reprocessing and correcting the errors in posted historical data.  We will release the corrected historical data as soon as possible and will notify the EIA Petroleum Data News recipients at that time. Sign up to receive messages for <a href="/tools/emailupdates/">EIA Petroleum Data News</a>.
</p>
<p>
PSM data for June 2017</br>
...
<p>
Data for pentanes plus and total liquefied petroleum gases continue to be available in the current release of data, but these data lines will be discontinued with release of PSM data on September 29, 2017.
</p>
<p>
...
<p>
Please watch for announcement of an upcoming webinar on the alkanes/olefins split in hydrocarbon gas liquids (HGL) data coming in mid-September.
</p>
</dl>
</div>
</div>

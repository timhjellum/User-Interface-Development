<?php
$pageTitle = "California Gasoline Price Study, 2003";
...
<h1>California Gasoline Price Study, 2003</h1>
<p class="date">May 1, 2003<br />
</p>
<p>California was scheduled to ban the use of methyl tertiary butyl ether (MTBE) in gasoline
in January 2003, but a number of factors caused the State to delay the ban for one year to
January 2004. Many California refiners chose to remove MTBE early, however, and at
...
addressing the specific questions asked by Congressman Ose. This is the final report, in
...
<p>California uses a reformulated gasoline that meets stricter emission standards than those
...
<p>The spring price surge was quite large. After a period of relative stability for much of
2002, gasoline prices throughout the United States began to rise in December. The
national average retail price for regular gasoline rose 37 cents per gallon between December 9, 2002, and March 17, 2003, reaching what was then an all-time record
...
<p>Gasoline price spikes are not unusual in California. Since the mid-1990s, California has
...
California include:
<ul>
<li>The California refinery system runs near its capacity limits, which means there is
little excess capability in the region to respond to unexpected shortfalls;
</li>
<li>California is isolated and lies a great distance from other supply sources (e.g., 14
days travel by tanker from the Gulf Coast), which prevents a quick resolution to
any supply/demand imbalances; and
</li>
<li>The region uses a unique gasoline that is difficult and expensive to make, and as a
result, the number of other suppliers who can provide product to the State are
limited.
</ul>
</p>
<p>Because short-term supply responses are no longer available to California, when supplydemand
imbalances occur, demand adjustments must play a larger role in returning the
...
<p>Another factor sometimes influences California prices â€“ the Arizona and Nevada
...
<p>Following the Spring gasoline price run-up, two other price surges occurred in 2003, one
...
<p>Price spikes occur when supply becomes tight, usually characterized by gasoline
...
<?php include('./includes/side-nav_caprice.inc'); ?>
</div>
</div

<?php
$pageTitle = "Drilling Sideways - A Review of Horizontal Well Technology and Its Domestic Application";
...
<h1>Drilling Sideways - A Review of Horizontal Well Technology and Its Domestic Application</h1>
<p class="date">April 1, 1993<br />
</p>
<p><strong>Highlights</strong> </p>
<p>The use of horizontal drilling technology in oil exploration, development, and production operations has
grown rapidly over the past 5 years. This report reviews the technology, its history, and its current
domestic application. It also considers related technologies that will increasingly affect horizontal
drilling&#8482;s future.
</p>
<p>Horizontal drilling technology achieved commercial viability during the late 1980&#8482;s. Its successful
...
<p>The technical objective of horizontal drilling is to expose significantly more reservoir rock to the well bore
...
<p>Domestic applications of horizontal drilling technology have included the drilling of fractured conventional
...
<p>An offset to the benefits provided by successful horizontal drilling is its higher cost. But the average cost
...
as companies move to new target reservoirs. It is probable that the cost premium associated with
...
<?php include('./includes/side-nav_sideways.inc'); ?>
</div>
</div>

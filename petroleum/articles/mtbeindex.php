<?php
$pageTitle = "Eliminating MTBE in Gasoline in 2006";
...
<p class="date"> February 22, 2006<br />
</p>
<p>In 2005, a number of petroleum companies announced their intent to remove methyl
...
<p>Currently, the largest use of MTBE is in RFG consumed on the East Coast outside of
New York and Connecticut and in Texas. The other RFG areas in the
...
from:
<ul>
<li>Net loss of gasoline production capacity</li><li>Tight ethanol market, limited in the short-run by ethanol-production capacity and
transportation capability to move increased volumes to areas of demand</li><li>Limited resources and permitting issues hampering gasoline suppliers abilities to
quickly get terminal facilities in place to store and blend ethanol</li><li>Loss of import supply sources that cannot deliver MTBE-free product, or that
cannot produce the high-quality blendstock needed to combine with ethanol </li>
</ul>
</p>
<p>The different properties between MTBE and ethanol affect not only production, but
...
<?php include('./includes/side-nav_mtbe.inc'); ?>
</div>
</div>

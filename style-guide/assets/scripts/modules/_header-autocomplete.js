...
$( function() {
    ...
    $('#survey').autocomplete({
        ...
        select: function(event, ui) {
            $('#survey').val(ui.item.label);
            $('#survey-id').val(ui.item.anchor);
            return false;
//            $('a#SurveySearch').attr('href', 'https://www.eia.gov/survey/index.php#')
            // + ui.item.anchor)
//            ; 
    ...
    $('#survey').autocomplete().data("uiAutocomplete")._renderItem = function(ul, item) {
        return $('<li>')
